...
### 👨‍💻 About Me
- 💻 Full Stack Developer (PHP, Laravel, MERN)
- 👨‍🏫 Programming Instructor — teaching Web Development at Code Academy Nowshera
- 🎓 Computer Science Teacher at Fauji Foundation College Nowshera
- 🚀 Founder, LogicGigs (software house)
- 🛠️ HTML • CSS • JavaScript • PHP • Laravel • MySQL • C • C++
- 🌱 Currently learning: **Laravel (Livewire) + React.js / Next.js** — building a full ERP system
...
### 🔭 Projects I've Built
- **Tailor Management System** — Core PHP
- **Hospital Management System** — Core PHP
- **Hotel Management System** — Core PHP
- **E-Commerce Management System** — Core PHP
- **School Management System** — Core PHP
- **MLM Management System** — Core PHP
- **FragVault** — gamified task/survey earning platform (Laravel 11, Livewire, Filament, MySQL) — *in development*
- **ERP System** — currently building with Laravel (Livewire) + React/Next.js

Delivered 50+ PHP-based projects for academic and freelance clients, with hands-on experience as a Level 2 Seller on Fiverr (3 completed projects) and ~8 months of industry experience at Mindgigs Pvt Ltd, Peshawar.

---

### 🌱 Currently Learning
- Laravel (Livewire) + React.js / Next.js — applied via a live ERP project
- MERN stack (MongoDB, Express, React, Node.js)
- Modern full-stack architecture & deployment (Vercel)
...
### 📫 Connect with Me
- **LinkedIn:** [Syed Amir Hayat](https://linkedin.com/in/syedamirhayat)
- **Instagram:** [@SyedAmirDev](https://instagram.com/syed__aami)
